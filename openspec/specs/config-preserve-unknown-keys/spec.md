...
Defines how the config system preserves unrecognized TOML keys during parsing, serialization, and layering, and specifies that list-typed fields use whole-list replacement.
